package com.example.maternapp.data
...
class HealthServicesRepository(context: Context) {
    ...
    private val TAG = "HealthServicesRepository"
    ...
    fun heartRateMeasureFlow() = callbackFlow {
        ...
        val callback = object : MeasureCallback {
            ...
            override fun onDataReceived(data: DataPointContainer) {
                ...
                val bpmValues = heartRateBpm.joinToString { it.value.toString() }
                Log.d(TAG, "heartRateBpm valores: $bpmValues")
            }
        }
